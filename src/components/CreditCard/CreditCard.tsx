...
const CreditCard: React.FC<TypeCreditCardProps> = (
  props: TypeCreditCardProps
) => {
    ...
    <div className={elClasses.join(' ')}>
      <div className='credit-card__front-wrapper'>
        ...
        <svg className='credit-card__front' viewBox='0 0 750 471'>
          <path
            className={['lightcolor', props.details.color].join(' ')}
            d='M0,0h750v471H0V0z'
          />
          <path
          ...
          <text
            ...
            className='credit-card__number st2 st3 st4'>
            {!!props.inputs.cardNumber.value
              ? props.inputs.cardNumber.value
              : '0123 4567 8910 1234'}
          </text>
          <text
            transform='matrix(1 0 0 1 54.1064 428.1723)'
            className='credit-card__holder st2 st5 st6'>
            {!!props.inputs.cardHolder.value
              ? props.inputs.cardHolder.value
              : 'JOHN DOE'}
          </text>
          <text
          ...
          <text
            ...
            className='credit-card__expire st2 st5 st9'>
      ...
      <div className='credit-card__back-wrapper'>
        <svg className='credit-card__back' viewBox='0 0 750 471'>
          ...
          <text
            ...
            className='credit-card__holder-back st12 st13'>
            {!!props.inputs.cardHolder.value
              ? props.inputs.cardHolder.value
              : 'John Doe'}
          </text>
